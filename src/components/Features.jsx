  ...
  const features = [
    {
      ...
      description: "From basketball to swimming, we cover all major sports with professionally organized events",
      bg: "bg-emerald-50"
    },
    {
      icon: <FaTrophy className="text-4xl text-blue-500" />,
      title: "Competitive Leagues",
      description: "Join tournaments with multiple skill divisions for fair and exciting competition",
      bg: "bg-blue-50"
    },
    {
      icon: <FaUsers className="text-4xl text-amber-500" />,
      title: "Community Building",
      description: "Connect with fellow athletes and build lasting sports relationships",
      bg: "bg-amber-50"
    },
    {
      icon: <FaCalendarAlt className="text-4xl text-purple-500" />,
      title: "Flexible Scheduling",
      description: "Events designed to fit your calendar with weekday and weekend options",
      bg: "bg-purple-50"
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-sm text-gray-600 max-w-3xl mx-auto">
            Designed for athletes by athletes - everything you need for the ultimate sports experience
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-emerald-100 mb-6 max-w-2xl mx-auto">
            Create your account today and get access to hundreds of sports events in your area
          </p>
          <motion.button
