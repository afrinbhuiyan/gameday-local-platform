    ...
    <div>
      <div className="relative w-full h-screen max-h-[800px] overflow-hidden">
        ...
        >
              ...
              <div className="absolute inset-0 z-20 flex items-center">
                <div className="container mx-auto px-6 lg:px-12">
                  ...
                  >
                    ...
                    <p className="text-sm text-white mb-8">{event.subtitle}</p>
          ...
          <div className="swiper-pagination absolute bottom-8 left-1/2 -translate-x-1/2 z-30 flex gap-2 !w-auto"></div>
        </Swiper>

        {/* Navigation controls */}
        <div className="absolute z-30 right-6 bottom-0 flex gap-6">
          <button className="swiper-prev p-3 md:p-5 lg:p-6 bg-[#1111119f] hover:bg-[#9ce979] text-white transition-all">
            <SlArrowLeft className="text-[15px] md:text-[20px] lg:text-[30px]" />
          </button>
          <button className="swiper-next p-3 md:p-5 lg:p-6 bg-[#1111119f] hover:bg-[#9ce979] text-white transition-all">
